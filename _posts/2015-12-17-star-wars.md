...
<div class="callout">This is an except from the course, <a href="/courses/animation-101/">CSS Animation 101</a>. The next course starts Monday! Learn all about CSS Animation, one email per day over 4 weeks.</div>
